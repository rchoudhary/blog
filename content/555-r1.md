...
<div class="figure-caption">I mean, I guess I could create a $2\text{ Hz}$ wave by just plugging and unplugging the power manually</div>
...
So <span class="highlight">rather than _increasing_ $R_1$, we can instead _decrease_ $R_2$ to get the same effect!</span>
